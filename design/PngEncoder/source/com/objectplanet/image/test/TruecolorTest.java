...
public class TruecolorTest {
	...
	private static PngEncoder objectplanet_png_encoder = new PngEncoder(PngEncoder.COLOR_TRUECOLOR);
	...
	public void runTest(boolean antialiased) {
		...
		chart.setTitle("Encoding Truecolor Image");
      ...
      chart.setBackground(Color.white);
		...
		try {
			...
			f.pack();
			f.setVisible(true);
			f.setBounds(0, 0, ImageEncoderTest.FRAME_SIZE.width, ImageEncoderTest.FRAME_SIZE.height);
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		try {
			...
			String path = "images/truecolor" + (antialiased ? "_antialiased" : "") + ".png";
	...
	public static void main(String[] argv) {
		TruecolorTest test = new TruecolorTest();
		test.runTest();
	}
}
